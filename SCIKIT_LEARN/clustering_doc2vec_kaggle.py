...
MODEL_DIR = "./doc2vec_data/doc2vec_kaggle_10_iter.model"
...
def sentence_2_vec(model, sentence):
    vector = []
    vector = np.array(model.infer_vector(sentence.split(" ")))
    vector.reshape(-1, SIZE_WORD2VEC_VECTOR)
    return vector
