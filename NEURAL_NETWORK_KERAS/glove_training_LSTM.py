...
x = LSTM(128, activation='relu', dropout=0.5, return_sequences=False)(embedded_sequences) # dropout original 0.5
x = Dense(64, activation='relu', kernel_regularizer=regularizers.l2(0.01))(x) # original 0.01
